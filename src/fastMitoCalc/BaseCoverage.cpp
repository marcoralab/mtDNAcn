...
int main(int argc, char** argv){
  ...
  if(argc==6)
   ...
   //will come out as '<bamFileLabel>MTData.txt'
   string outfileName = workDir + "/" + bamLabel + "MTData.txt";
   ifstream infile;
   ...
   int AutosomeUsed[22];
      ...
      outfile << "autosomal_coverage: " << autoZcoverage << endl;
      outfile << "actual basepairs covered by reads: " << bpcnt << endl;
      outfile << "chrom_used_for_autosomal_coverage: ";
      if(AutosomeCnt<22) {
