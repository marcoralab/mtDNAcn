...
mayo <- mayo.raw %>%
  ...
  select(id, study, sex = Sex, apoe = ApoE, apoe4, race, aod, aod_cat, thal = Thal, braaksc, SourceTissue = WGS_Source_Tissue_Type, dx = Diagnosis, mtcn_avg, Haplogroup, Quality, macro)
