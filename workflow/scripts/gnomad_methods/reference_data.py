...
from workflow.scripts.gnomad.resource_utils import (
...
from workflow.scripts.gnomad.vep import vep_or_lookup_vep
import hail as hl
...
dbsnp = VersionedTableResource(
    ...
    versions={
        ...
        "b151": GnomadPublicTableResource(
            ...
            import_args={
                "path": "/sc/arion/projects/LOAD/shea/Projects/mtDNAcn/raw/gnomad_resources/All_20180418.vcf.gz",
                "header_file": "/sc/arion/projects/LOAD/shea/Projects/mtDNAcn/raw/gnomad_resources/All_20180418.vcf.header",
                "force_bgz": True,
                "contig_recoding": NO_CHR_TO_CHR_CONTIG_RECODING,
                "skip_invalid_loci": True,
                "min_partitions": 400,
